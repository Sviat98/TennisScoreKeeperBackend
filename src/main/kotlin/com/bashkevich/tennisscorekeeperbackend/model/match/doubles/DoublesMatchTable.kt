...
object DoublesMatchTable : IdTable<Int>("doubles_match") {
    ...
    val firstParticipantPrimaryColor = varchar("first_participant_primary_color", 6)
    ...
    val secondParticipantPrimaryColor = varchar("second_participant_primary_color", 6)
